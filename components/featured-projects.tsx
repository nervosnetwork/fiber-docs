  ...
  return (
    ...
    >
      <div className="self-stretch flex flex-wrap justify-start items-start">
        <div className="w-1/2 md:flex-1 border border-invisible inline-flex flex-col justify-start items-start gap-sm hover-border-bright">
          <div
            data-hovered="false"
            data-showgithub="true"
            data-showlink="true"
            className="w-full h-48 p-sm inline-flex flex-col justify-start items-start gap-sm"
          >
            ...
            <div className="inline-flex justify-start items-center gap-xs">
            ...
            <div className="self-stretch text-tertiary text-body2">
        ...
        <div
          ...
          className="w-1/2 md:w-48 h-48 p-sm border border-invisible inline-flex flex-col justify-center items-center gap-xs cursor-pointer hover-invert"
        >
          <Image src="/external.svg" alt="Arrow" width={20} height={20} />
          <div className="text-primary text-button whitespace-nowrap">
            VIEW ALL PROJECTS
          </div>
        </div>
      </div>
