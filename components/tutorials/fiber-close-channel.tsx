...
export function FiberCloseChannelTutorial() {
  ...
  return <RoutingTutorialFrame article={article} codeFiles={codeFiles} currentTutorialIndex={8} defaultFile="close" demoDescription="Cooperatively close a real Testnet channel and watch its final balance return on-chain." demoTitle="Run the Channel Recovery Demo" downloadHref="/downloads/fiber-close-channel.zip" liveDemo={liveDemo} previousHref="/docs/build/rusd-payment" sectionCode={sectionCode}/>;
}
