...
export function FiberHoldInvoiceTutorial() {
  ...
  return <RoutingTutorialFrame article={article} codeFiles={codeFiles} currentTutorialIndex={4} defaultFile="hold" demoDescription="Create a real Hold Invoice, observe the pending receiver state, then settle or cancel it." demoTitle="Run the Hold Invoice Demo" downloadHref="/downloads/fiber-hold-invoice.zip" liveDemo={liveDemo} nextHref="/docs/build/encrypted-data-payment" previousHref="/docs/build/unidirectional-channel" sectionCode={sectionCode}/>;
}
