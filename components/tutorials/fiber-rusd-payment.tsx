...
export function FiberRusdPaymentTutorial() {
  ...
  return <RoutingTutorialFrame article={article} codeFiles={codeFiles} currentTutorialIndex={7} defaultFile="asset" demoDescription="Fund a real RUSD channel on Testnet and send stablecoin liquidity through Fiber." demoTitle="Run the RUSD Payment Demo" downloadHref="/downloads/fiber-rusd-payment.zip" liveDemo={liveDemo} nextHref="/docs/build/close-channel" previousHref="/docs/build/verified-result-payment" sectionCode={sectionCode}/>;
}
