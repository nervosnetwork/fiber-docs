...
author: YuKang Chen
authorUrl: https://github.com/yukangchen
date: 2025-09-05
---
...
![image](/imgs/docs/high-level/decrypt-receive.png)
...
- **Storage**: We use RocksDB as the storage layer, leveraging its scheme-less storage design to simplify encoding and decoding structs with `serde`. Data migration remains a challenge, which we address by [this standalone program](https://github.com/nervosnetwork/fiber/blob/v0.8.0/migrate/src/main.rs).
