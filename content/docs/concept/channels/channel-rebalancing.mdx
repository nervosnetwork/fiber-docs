...
- [`send_payment`](/docs/build/api-reference/payment#method-send_payment)
- [`build_router`](/docs/build/api-reference/payment#method-build_router)
- [`send_payment_with_router`](/docs/build/api-reference/payment#method-send_payment_with_router)
- [`list_channels`](/docs/build/api-reference/channel#method-list_channels)
