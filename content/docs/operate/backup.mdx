...
description: "Back up and restore Fiber v0.9.1 node data"
date: 2026-09-14
author: "gpBlockchain"
...
When the Fiber service is running, v0.9.1 schedules a backup every 24 hours.
...
For a complete v0.8.x data-directory backup, extract it and start the v0.9.1
...
### From v0.7.x or Older to v0.9.1
