...
Browser and `fiber-wasm` clients should use a public node WebSocket or WebSocket Secure multiaddr when one is available:
...
- [`connect_peer`](/docs/build/api-reference/peer#method-connect_peer)
- [`list_peers`](/docs/build/api-reference/peer#method-list_peers)
