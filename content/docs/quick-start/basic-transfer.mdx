...
Download and extract the v0.9.1 portable archive as described in [Run a Native Node](/docs/quick-start/run-a-node/rust). The extracted directory contains `fnn`, `fnn-cli`, and `config/testnet/config.yml`.
