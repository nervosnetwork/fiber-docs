...
- Use the v0.9.1 <code>fnn</code>, <code>fnn-cli</code>, and <code>config/testnet/config.yml</code> files from the same [release package](https://github.com/nervosnetwork/fiber/releases/tag/v0.9.1).
