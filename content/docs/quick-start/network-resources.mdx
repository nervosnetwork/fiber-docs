...
Download the pinned [Fiber Node v0.9.1 release](https://github.com/nervosnetwork/fiber/releases/tag/v0.9.1). Choose the asset matching your operating system and CPU architecture; each archive includes `fnn`, `fnn-cli`, and network config files.
