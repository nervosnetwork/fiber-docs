...
This document used the [v0.7.1 binary](https://github.com/nervosnetwork/fiber/releases/tag/v0.7.1) throughout the guide.
...
```
( If compiling from source code locally, need `cd` to the [`./migrate`](https://github.com/nervosnetwork/fiber/tree/v0.7.1/migrate). )
...
Check out the [Basic Transfer Example](/docs/quick-start/basic-transfer) guide for a practical example of using your node.
