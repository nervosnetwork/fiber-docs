...
For the full API reference see [Build -> fiber-js](/docs/build/fiber-js).

## Next Steps

- [Basic Transfer](/docs/quick-start/basic-transfer) — learn the channel and payment flow
- [JavaScript Overview](/docs/build/fiber-js) — browser runtime, security headers, and API details
