...
dependencies:
  - name: Fiber Node
    minVersion: "0.7.1"
    link: "https://github.com/nervosnetwork/fiber/releases/tag/v0.7.1"
---
...
The full code of the game can be found in the [github repo](https://github.com/ashuralyk/fiber-game-example).
...
The demo project can be found in the [github repo](https://github.com/ashuralyk/fiber-game-example).
...
```bash
# git clone the repo
git clone https://github.com/ashuralyk/fiber-game-example.git
cd fiber-game-example
...
```bash
pnpm add @ckb-ccc/fiber@0.0.0-canary-20260330023358
```
