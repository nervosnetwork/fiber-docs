...
<VersionBadge 
  ...
  date="Mar 13, 2025"
  dependencies={[
    { name: "Fiber Node", minVersion: "0.4.0", link: "https://github.com/nervosnetwork/fiber/releases/tag/v0.4.0" },
  ]}
/>
...
<img className="max-w-[600px] mx-auto" src="/imgs/docs/simple-game/game-cover.png" alt="Game Cover" />
...
<img className="max-w-[600px] mx-auto" src="/imgs/docs/simple-game/game-running.png" alt="Game Running" />
...
<img className="max-w-[600px] mx-auto" src="/imgs/docs/simple-game/game-over.png" alt="Game Over" />
